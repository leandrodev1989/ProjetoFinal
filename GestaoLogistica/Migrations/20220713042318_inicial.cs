    ...
    public partial class inicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Produtos", x => x.FornecedorId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConferirCargaId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Conferentes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Conferentes_ConferirCarga_ConferirCargaId",
                        column: x => x.ConferirCargaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conferentes_ConferirCargaId",
                table: "Conferentes",
